...
if opt.data == 'breast':
    ...
    root_dir = "/beegfs/sb3923/DeepCancer/alldata/mburden/LUSC/LuscTilesSorted/"
    num_classes = 2
    tile_dict_path = '/beegfs/sb3923/DeepCancer/alldata/mburden/LUSC/Lusc_FileMappingDict.p'
elif opt.data == 'luad':
...
for epoch in range(opt.niter+1):
    ...
    # Get validation AUC once per epoch , 10/16/18 changing this to train, SB
    val_predictions, val_labels = aggregate(data['train'].filenames, method=opt.method)
