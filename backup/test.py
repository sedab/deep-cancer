...
#class_name = ['ST_Normal_Breast','ST_Normal_Kidney','ST_Normal_Lung','TCGA-BRCA','TCGA-KICH','TCGA-KIRC','TCGA-KIRP','TCGA-LUAD','TCGA-LUSC']
class_name = ['high','low']
...
if opt.data == 'breast':
    ...
    root_dir = "/beegfs/sb3923/DeepCancer/alldata/mburden/LuscTilesSorted/"
    num_classes = 2
    tile_dict_path = '/beegfs/sb3923/DeepCancer/alldata/mburden/Lusc_FileMappingDict.p'
elif opt.data == 'kirp':
    root_dir = "/beegfs/sb3923/DeepCancer/alldata/mburden/KIRP/KirpTilesSorted/"
    num_classes = 2
    tile_dict_path = '/beegfs/sb3923/DeepCancer/alldata/mburden/KIRP/Kirp_FileMappingDict.p'
elif opt.data == 'luad':
    root_dir = "/beegfs/sb3923/DeepCancer/alldata/mburden/LUAD/LuadTilesSorted/"
    num_classes = 2
    tile_dict_path = '/beegfs/sb3923/DeepCancer/alldata/mburden/LUAD/Luad_FileMappingDict.p'
elif opt.data == 'brca':
    root_dir = "/beegfs/sb3923/DeepCancer/alldata/mburden/BRCA/BrcaTilesSorted/"
    num_classes = 2
    tile_dict_path = '/beegfs/sb3923/DeepCancer/alldata/mburden/BRCA/Brca_FileMappingDict.p'
else:
...
#roc_auc,fpr,tpr = get_auc('experiments/{0}/images/test_AUC_avg_{1}.jpg'.format(opt.experiment,opt.model),
#                  predictions, labels, class_name, classes = range(num_classes))
