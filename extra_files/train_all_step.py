...
parser.add_argument('--data', type=str, default='alldata_ds', help='Data to train on (lung/breast/kidney)')
...
#tile_dict_path = '/beegfs/sb3923/DeepCancer/alldata/AlldataFileMappingDict.p'
